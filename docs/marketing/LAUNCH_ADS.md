...
Healthcare-blue, calm, credible, operationally complete. This should feel like production-grade SaaS for home healthcare operators, not a generic AI demo.

Type and color cues:

- Display font: Inter Tight or Sohne, semibold for headlines.
- Primary blue: `#0B5FB1`
- Accent teal: `#10A4A4`
...
- 150 wpm, roughly 75 words per 30-second spot.
- Where copy is shorter, use the breathing room for music swells or held end frames.

## 1. Hero / Launch Spot - "Care, finally on the same page."

Audience: broad - investors, agency operators, conference floor.

Placement: YouTube pre-roll, LinkedIn, conference reel, agency association newsletters.

Mood: confident, hopeful, grounded. Slightly cinematic, not aspirational-stock.

Music: warm piano plus soft synth pad, subtle pulse around the 18s mark. Resolve on a sustained chord.
...
- Subtle UI tick when the dashboard tabs in around 10s.
- Soft heartbeat pulse from 18-22s.
- Logo whoosh plus clean snap on end frame.

## 2. Agency Owner - "Run the agency, not the spreadsheet."

Audience: agency owners, administrators, ops directors.

Placement: Meta and LinkedIn paid social, Google Search retargeting, home-care association sponsored slots.

Mood: wry to relieved. Acknowledge that operators are tired.

Music: light percussion under the pain section, lifting to a clean ambient progression at the turn.
...
`Scheduling · EVV · Billing readiness · Payroll approvals · QA · Training`

## 3. Caregiver - "A workday that respects your time."

Audience: caregivers, CNAs, home health aides.

Placement: Meta and TikTok paid social targeting healthcare worker affinity, in-app onboarding video, recruiter pages.

Mood: warm, real, respectful. Treat caregivers like the experts they are.

Music: acoustic guitar plus soft pad. Layer real-life ambient sounds: kettle, door close, gentle laugh.

| Time | Visual | On-screen text |
| --- | --- | --- |
| 0.0-4.0s | Caregiver knocks softly and enters a client's living room. Phone in scrub pocket. | - |
| 4.0-9.0s | POV mobile screen: tap, Clock In, Location confirmed, Care plan loaded. | Clock-in, done. |
...
- Real ambient bed: soft clock tick, kettle, soft greeting.
- One gentle UI confirmation chime at clock-in.
- No alert sound effects.

## 4. Family - "Closer to the people you love."

Audience: adult children of clients, decision-making family members.

Placement: Meta and YouTube targeting ages 45-65, hospital discharge-planner referral pages.

Mood: tender, calm, trustworthy. Lead with relief, not fear.

Music: soft strings plus piano. No drums. Resolve on a held minor-to-major lift.
...
Audience: ops directors, compliance leads, agencies anxious about EVV and the 21st Century Cures Act.

Placement: LinkedIn sponsored, industry publications, webinar bumpers.

Mood: confident, technical, no-nonsense.

Music: restrained piano plus low ambient bed.
...
Audience: YouTube non-skippable bumpers, programmatic video.

Style: single-card, single line, single logo reveal. No VO.
...
- Single soft swell plus one logo whoosh.
- No dialogue.

## 7. Audio-only Cutdown

Length: 30s.

Placement: Spotify, podcast, radio.

Bed: same warm piano-pad cue from the hero spot, mixed to -20 LUFS dialogue. End on a sustained chord. No SFX above -12 dB.
...
- Legal/compliance review:
  - Confirm "EVV verified" and "21st Cures Act ready" match current product behavior.
  - Keep payroll language to readiness, approvals, exports, or authorized payroll-provider handoff.
  - Confirm GPS and PHI claims match actual app behavior and privacy disclosures.
- A/B variants:
  - "Care, on the same page." vs. "Run the agency, not the spreadsheet."
  - "Book an agency demo" vs. "Start a free trial", depending on go-to-market state.
- Tracking:
  - UTM-tag every end-frame URL by ad and placement.
  - Suggested audience pages: `/agency-demo`, `/caregivers`, `/family`, `/compliance`.

## Funnel Map

| Funnel stage | Lead asset | Supporting cuts |
| --- | --- | --- |
| Awareness | Hero 30s | Bumper 6s for retargeting frequency |
| Consideration | Agency Owner 30s | Compliance 30s for ops/risk personas |
| Trust | Caregiver 30s and Family 30s | Audio cutdown on healthcare podcasts |
| Reactivation | Hero 30s and Bumper 6s | UTM-retargeted variants for lapsed page viewers |
