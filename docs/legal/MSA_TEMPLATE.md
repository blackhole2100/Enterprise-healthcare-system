...
**NOTICE: This is a template. Have a licensed attorney review and finalize before use.**

---

This Master Service Agreement ("Agreement") is entered into as of __________ ("Effective Date") by and between:
...
2.1 **Subscription Fees.** Agency shall pay the fees specified in the applicable Order Form. Fees are invoiced monthly in advance.
...
3.1 **Initial Term.** This Agreement begins on the Effective Date and continues for 12 months unless terminated earlier.

3.2 **Renewal.** The Agreement automatically renews for successive 12-month terms unless either party gives written notice of non-renewal at least 60 days before the end of the then-current term.

3.3 **Termination for Cause.** Either party may terminate immediately if the other: (a) materially breaches and fails to cure within 30 days of written notice; (b) becomes insolvent or files for bankruptcy; or (c) ceases operations.
...
4.1 Agency is responsible for ensuring its staff use the Services in compliance with all applicable laws, including state EVV mandate requirements.
...
7.1 Each party shall protect the other's Confidential Information with at least the same care it uses for its own confidential information (no less than reasonable care) and shall not disclose it to third parties except as needed to fulfill this Agreement.

7.2 "Confidential Information" excludes information that: (a) is or becomes publicly known without fault of the Receiving Party; (b) was already known before disclosure; (c) is independently developed; or (d) must be disclosed by law (with prompt notice to the Disclosing Party).

7.3 Confidentiality obligations survive for 3 years after termination.
...
9.1 NEITHER PARTY SHALL BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES, INCLUDING LOST PROFITS OR DATA.

9.2 TOTAL LIABILITY OF EITHER PARTY SHALL NOT EXCEED FEES PAID BY AGENCY IN THE 12 MONTHS PRECEDING THE CLAIM.

9.3 These caps do not apply to indemnification obligations, gross negligence, willful misconduct, or breach of confidentiality.
...
11.1 **Governing Law.** This Agreement is governed by Delaware law. Disputes are resolved in Wilmington, Delaware courts.

11.2 **Notices.** Legal notices require certified mail; operational notices may be by email.
...
11.6 **Severability / Waiver.** Unenforceable provisions are modified to the minimum extent needed. Failure to enforce a right is not a waiver of future enforcement.
