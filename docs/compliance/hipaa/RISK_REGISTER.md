...
| 2026-07-16 | Engineering-assisted source review | R-010: shipped a native fraud-scoring engine (four detectors on existing EVV data) so the RayVerify "fraud intelligence — live" claim is now implemented; reconciled the RayVerify marketing to those four signals and labeled identity/liveness/device-trust/shared-device "rolling out". Telephony/IVR and family-portal copy still to reconcile |
