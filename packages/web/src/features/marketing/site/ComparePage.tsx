...
/**
 * Company › Compare: Health vs. the old way.
...
const ROWS: CompareRow[] = [
  {
    ...
    health: 'Native: GPS-verified clock-in/out, offline-safe, exceptions engine',
  },
  {
    capability: 'Missed or offline visits',
    spreadsheets: 'Reconstructed from memory at week end',
    legacy: 'Manual corrections queue',
    health: 'Encrypted offline queue replays punches with original capture times',
  },
  {
    capability: 'Claims',
    spreadsheets: 'Typed into the portal, claim by claim',
    legacy: 'Batch generation, scrubbing varies',
    health: '837P generated from verified visits, validated before submission',
  },
  {
  ...
  },
  {
    ...
    health: 'Audit packet generated from tamper-evident records on demand',
  },
  {
    capability: 'Visit documentation',
    spreadsheets: 'Paper notes, sometimes transcribed',
    legacy: 'Free-text box',
    health: 'Task checklist + note at clock-out, with AI polish the caregiver reviews',
  },
  {
    capability: 'Contracts',
    spreadsheets: 'Free, and worth it',
    legacy: 'Annual contracts, per-seat pricing common',
    health: 'Month-to-month, no per-seat licenses',
  },
];
...
const WHY_CARDS = [
  ...
  },
  {
    ...
    body: 'No platform makes an audit disappear. What Health promises is that the record you need is captured at the moment of care and retrievable in seconds.',
    icon: mkic(
      <>
  ...
  },
  {
    ...
    body: 'Health is built for the agency running dozens of caregivers — not a downsized enterprise suite with modules you will never open.',
    icon: mkic(
      <>
    ...
    <SiteLayout>
      <header className="mk-hero">
        ...
        <div className="mk-heroin">
          ...
          <h1 className="mk-h1">Health vs. the old way.</h1>
          <p className="mk-lead">
      ...
      <section className="mk-sec">
        <div className="mk-wrap">
          <div className="mk-callout">
            ...
            <p>
              Bring one week of real visits and run them through Health in parallel with your
