...
describe('authorization routes', () => {
  ...
  it('updates units via PUT', async () => {
    ...
    vi.spyOn(core, 'ClientRepository').mockImplementation(() => ({ updateAuthorization } as any));
  ...
  it('deletes an authorization (204) and 404s an unknown one', async () => {
    ...
    vi.spyOn(core, 'ClientRepository').mockImplementation(() => ({ deleteAuthorization } as any));
